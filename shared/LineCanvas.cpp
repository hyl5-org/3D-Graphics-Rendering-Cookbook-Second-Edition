                          ...
                          uint32_t numSamples)
{
    ...
    {
        linesBuffer_[currentFrame_] = ctx.createBuffer({.usage = lvk::BufferUsageBits_Storage,
        ...
        pipeline_ = ctx.createRenderPipeline(
            {
                ...
                .depthFormat =
                    desc.depthStencil.texture ? ctx.getFormat(desc.depthStencil.texture) : lvk::Format_Invalid,
