                 ...
                 HDRPass &hdr, VulkanApp &app)
{
    ...
    ImGui::Checkbox("Transparent meshes", &gSettings.draw.meshesTransparent);
    ...
    {
        ImGui::Indent(indentSize);
        ImGui::SliderFloat("Opacity boost", &gSettings.oit.opacityBoost, -1.0f, +1.0f);
        ImGui::Checkbox("Show transparency heat map", &gSettings.oit.showHeatmap);
        ImGui::Unindent(indentSize);
        ImGui::Separator();
    }
    ...
    if (ImGui::CollapsingHeader("Shadow Mapping"))
    {
        ...
        ImGui::Indent(indentSize);
        ImGui::SliderFloat("Constant", &gSettings.light.depthBiasConst, 0.0f, 5.0f);
        ImGui::SliderFloat("Slope", &gSettings.light.depthBiasSlope, 0.0f, 5.0f);
        ImGui::Unindent(indentSize);
        ImGui::Separator();
